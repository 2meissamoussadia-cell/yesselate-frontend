...
/**
 * Foncier — Vue Outlook-like (layout 3 colonnes)
 */
...
import { foncierModuleConfig } from '@/lib/config/modules/foncier.config';
import { cn } from '@/lib/utils';

interface FoncierItem {
  id: string;
  titre: string;
  statut: string;
  dateCreation: string;
...
const MOCK_ITEMS: FoncierItem[] = [
  { id: '1', titre: 'Exemple', statut: 'Actif', dateCreation: new Date().toISOString() },
];

export default function FoncierOutlookPage() {
