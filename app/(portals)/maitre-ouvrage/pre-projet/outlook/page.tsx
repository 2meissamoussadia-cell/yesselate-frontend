...
/**
 * PreProjet — Vue Outlook-like (layout 3 colonnes)
 */
...
const MOCK_ITEMS: PreProjetItem[] = [
  { id: '1', titre: 'Exemple', statut: 'Actif', dateCreation: new Date().toISOString() },
];

export default function PreProjetOutlookPage() {
  ...
  const quickActions = (
    <QuickActionsBar
      primaryLabel="Nouveau pré-projet"
