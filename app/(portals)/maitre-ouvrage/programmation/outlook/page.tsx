...
/**
 * Programmation — Vue Outlook-like (layout 3 colonnes)
 */
...
import { programmationModuleConfig } from '@/lib/config/modules/programmation.config';
...
const MOCK_ITEMS: ProgrammationItem[] = [
  { id: '1', titre: 'Exemple', statut: 'Actif', dateCreation: new Date().toISOString() },
];

export default function ProgrammationOutlookPage() {
  ...
  const quickActions = (
    <QuickActionsBar
      primaryLabel="Nouvelle programmation"
  ...
  return (
    <BmoModulePage
      ...
      config={programmationModuleConfig}
      items={items}
      ...
      emptyMessage="Aucune programmation"
