    ...
    <div className="flex flex-col h-full min-h-0">
      ...
      >
        ...
        <label className="relative flex items-center">
          <Search
            className="absolute left-2.5 h-3.5 w-3.5 text-slate-500 pointer-events-none"
            aria-hidden
          />
          <input
            type="search"
            ...
            className={cn(
              'w-48 pl-8 pr-2.5 py-1.5 rounded-lg border border-slate-700 bg-slate-900 text-xs text-slate-100 placeholder:text-slate-500',
