    ...
    >
      {COLUMNS.map((col) => (
        ...
        >
          ...
          <div className="flex-1 min-w-0 max-w-full overflow-x-hidden overflow-y-auto p-2 space-y-2">
            {byPhase[col.phase].map((row) => (
              ...
              >
                ...
                <div className="flex items-center justify-between mt-2 gap-2">
                  <span className="text-[0.65rem] text-slate-400 flex items-center gap-0.5">
