      ...
      >
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-800/50 bg-slate-800/30">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-lg font-semibold text-slate-100">Paramètres logs</h2>
          </div>
        ...
        <div className="p-6 space-y-4">
          <p className="text-sm text-slate-400">Rétention, niveau min, alertes. À brancher sur la config backend.</p>
