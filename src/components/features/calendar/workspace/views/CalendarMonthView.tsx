        ...
        {showFilters && (
          <div className="px-4 py-3 border-t border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50">
            <div className="flex flex-wrap items-center gap-3">
              ...
              {/* Category */}
              <Select value={filters.category} onValueChange={(v) => setFilters(f => ({ ...f, category: v as FilterCategory }))}>
              ...
              {/* Priority */}
              <Select value={filters.priority} onValueChange={(v) => setFilters(f => ({ ...f, priority: v as FilterPriority }))}>
                <SelectTrigger className="h-9 min-w-[120px] rounded-lg border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-sm">
