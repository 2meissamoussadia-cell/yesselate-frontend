/**
 * Configuration du module Pre projet
 */
import type { ModuleConfig } from '@/lib/types/module.types';

export const preProjetModuleConfig: ModuleConfig = {
  id: 'pre-projet',
  name: 'Pré-projet',
  layout: 'triple-pane',
    ...
    sections: [
      {
        title: 'DOSSIERS',
        items: [
          { id: 'tous', label: 'Tous les pré-projets', icon: 'Inbox', badge: 0 },
  ...
  quickActions: {
    primary: { label: 'Nouveau pré-projet', icon: 'Plus' },
    secondary: [
