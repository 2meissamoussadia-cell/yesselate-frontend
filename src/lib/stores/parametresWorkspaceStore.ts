...
export type ParametresTabType = 'general' | 'security' | 'notifications' | 'integrations' | 'permissions' | 'backup' | 'dashboard' | 'api-webhooks' | 'innovation-3d' | 'innovation-iot' | 'blockchain';
