    ...
    >
      <div
        className={cn(
          ...
          'border-slate-200 bg-white dark:border-slate-800/60 dark:bg-slate-900/40'
        )}
      >
        <div className="flex items-center justify-between px-4 py-3 border-b border-slate-200 dark:border-slate-800/60 bg-slate-50 dark:bg-slate-950/40">
          <h2 id="chantier-detail-title" className="text-lg font-semibold text-slate-900 dark:text-slate-100">
            {chantier.id}
          </h2>
          <button
            type="button"
        ...
        <div className="p-4 space-y-4">
          ...
          <div className="pt-4 border-t border-slate-200 dark:border-slate-800/60">
            <p className="text-xs text-slate-500 dark:text-slate-400 mb-2">Paiement instantané Orange Money</p>
            <OrangeMoneyButton
