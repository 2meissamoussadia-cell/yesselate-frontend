...
export const AdminLogsSystemePage = memo(function AdminLogsSystemePage() {
  ...
  return (
    <DashboardPageLayout>
      ...
      <DashboardSection title="AdminLogsSysteme" description="TODO: Ajouter description">
