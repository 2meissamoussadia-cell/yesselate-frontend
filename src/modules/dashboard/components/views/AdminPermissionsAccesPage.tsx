...
export const AdminPermissionsAccesPage = memo(function AdminPermissionsAccesPage() {
  ...
  return (
    <DashboardPageLayout>
      ...
      <DashboardSection title="AdminPermissionsAcces" description="TODO: Ajouter description">
