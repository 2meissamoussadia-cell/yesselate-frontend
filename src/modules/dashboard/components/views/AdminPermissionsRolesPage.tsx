...
export const AdminPermissionsRolesPage = memo(function AdminPermissionsRolesPage() {
  ...
  return (
    <DashboardPageLayout>
      ...
      <DashboardSection title="AdminPermissionsRoles" description="TODO: Ajouter description">
