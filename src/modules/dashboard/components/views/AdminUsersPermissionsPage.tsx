...
export const AdminUsersPermissionsPage = memo(function AdminUsersPermissionsPage() {
  ...
  return (
    <DashboardPageLayout>
      ...
      <DashboardSection title="AdminUsersPermissions" description="TODO: Ajouter description">
