...
export const PerformanceBureauxAllPage = memo(function PerformanceBureauxAllPage() {
  ...
  return (
    <DashboardPageLayout>
      ...
      <DashboardSection title="PerformanceBureauxAll" description="TODO: Ajouter description">
