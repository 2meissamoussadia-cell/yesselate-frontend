...
export const PerformanceBureauxBcgPage = memo(function PerformanceBureauxBcgPage(props: { data?: BureauSingleData | null }) {
  const [searchQuery, setSearchQuery] = React.useState('');
  const raw = props.data as BureauSingleData | undefined;
  const bureau = raw?.bureau ?? { code: 'bcg', label: 'BCG' };
  ...
  return (
    <DashboardPageLayout>
      <DashboardSection title={`Bureau ${bureau.label}`} subtitle={`Indicateurs du bureau ${bureau.label}.`}>
