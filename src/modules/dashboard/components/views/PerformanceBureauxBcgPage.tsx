...
export const PerformanceBureauxBcgPage = memo(function PerformanceBureauxBcgPage() {
  ...
  return (
    <DashboardPageLayout>
      ...
      <DashboardSection title="PerformanceBureauxBcg" description="TODO: Ajouter description">
