...
export const PerformanceBureauxBctPage = memo(function PerformanceBureauxBctPage(props: { data?: BureauSingleData | null }) {
  const [searchQuery, setSearchQuery] = React.useState('');
  const raw = props.data as BureauSingleData | undefined;
  const bureau = raw?.bureau ?? { code: 'bct', label: 'BCT' };
