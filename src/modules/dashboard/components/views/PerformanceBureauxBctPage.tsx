...
export const PerformanceBureauxBctPage = memo(function PerformanceBureauxBctPage() {
  ...
  return (
    <DashboardPageLayout>
      ...
      <DashboardSection title="PerformanceBureauxBct" description="TODO: Ajouter description">
