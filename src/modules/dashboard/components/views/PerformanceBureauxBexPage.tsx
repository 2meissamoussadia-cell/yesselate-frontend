...
export const PerformanceBureauxBexPage = memo(function PerformanceBureauxBexPage() {
  ...
  return (
    <DashboardPageLayout>
      ...
      <DashboardSection title="PerformanceBureauxBex" description="TODO: Ajouter description">
