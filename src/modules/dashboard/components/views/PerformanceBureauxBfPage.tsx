...
export const PerformanceBureauxBfPage = memo(function PerformanceBureauxBfPage(props: { data?: BureauSingleData | null }) {
  const [searchQuery, setSearchQuery] = React.useState('');
  const raw = props.data as BureauSingleData | undefined;
  const bureau = raw?.bureau ?? { code: 'bf', label: 'BF' };
