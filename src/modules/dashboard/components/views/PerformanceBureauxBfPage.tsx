...
export const PerformanceBureauxBfPage = memo(function PerformanceBureauxBfPage() {
  ...
  return (
    <DashboardPageLayout>
      ...
      <DashboardSection title="PerformanceBureauxBf" description="TODO: Ajouter description">
