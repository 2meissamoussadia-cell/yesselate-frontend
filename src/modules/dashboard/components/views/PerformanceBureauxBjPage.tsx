...
export const PerformanceBureauxBjPage = memo(function PerformanceBureauxBjPage() {
  ...
  return (
    <DashboardPageLayout>
      ...
      <DashboardSection title="PerformanceBureauxBj" description="TODO: Ajouter description">
