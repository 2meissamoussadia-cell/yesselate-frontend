...
export const PerformanceBureauxBmoPage = memo(function PerformanceBureauxBmoPage() {
  ...
  return (
    <DashboardPageLayout>
      ...
      <DashboardSection title="PerformanceBureauxBmo" description="TODO: Ajouter description">
