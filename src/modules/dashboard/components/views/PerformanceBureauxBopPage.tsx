...
export const PerformanceBureauxBopPage = memo(function PerformanceBureauxBopPage() {
  ...
  return (
    <DashboardPageLayout>
      ...
      <DashboardSection title="PerformanceBureauxBop" description="TODO: Ajouter description">
