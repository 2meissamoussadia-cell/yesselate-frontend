...
export const PerformanceBureauxBplPage = memo(function PerformanceBureauxBplPage() {
  ...
  return (
    <DashboardPageLayout>
      ...
      <DashboardSection title="PerformanceBureauxBpl" description="TODO: Ajouter description">
