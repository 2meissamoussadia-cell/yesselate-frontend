...
export const PerformanceBureauxBrcPage = memo(function PerformanceBureauxBrcPage(props: { data?: BureauSingleData | null }) {
  const [searchQuery, setSearchQuery] = React.useState('');
  const raw = props.data as BureauSingleData | undefined;
  const bureau = raw?.bureau ?? { code: 'brc', label: 'BRC' };
