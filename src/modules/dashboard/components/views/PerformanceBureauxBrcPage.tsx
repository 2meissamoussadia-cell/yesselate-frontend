...
export const PerformanceBureauxBrcPage = memo(function PerformanceBureauxBrcPage() {
  ...
  return (
    <DashboardPageLayout>
      ...
      <DashboardSection title="PerformanceBureauxBrc" description="TODO: Ajouter description">
