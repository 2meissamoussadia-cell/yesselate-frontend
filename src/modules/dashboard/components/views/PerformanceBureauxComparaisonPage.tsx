/**
 * Page PerformanceBureauxComparaison
...
export const PerformanceBureauxComparaisonPage = memo(function PerformanceBureauxComparaisonPage() {
  ...
  return (
    <DashboardPageLayout>
      ...
      <DashboardSection title="PerformanceBureauxComparaison" description="TODO: Ajouter description">
