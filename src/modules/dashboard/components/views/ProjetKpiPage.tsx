...
export const ProjetKpiPage = memo(function ProjetKpiPage({ data: apiData }: ProjetKpiPageProps = {}) {
  ...
  const projetKPIs: ProjetKPI[] = useMemo(() => [
    ...
    },
    {
      ...
      value: `${kpiCalculations.risquesCritiques} (${formatKPICurrency(kpiCalculations.risquesCritiquesImpact, 'XOF')})`,
      trend: '+1',
      trendDirection: 'up',
      icon: AlertTriangle,
  ...
  const handleExportCSV = useCallback(() => {
    ...
    const rows = filteredProjets.map(p => [
      ...
      p.retard.toString(),
      formatKPICurrency(p.budget.alloue, 'XOF'),
      formatKPICurrency(p.budget.consomme, 'XOF'),
